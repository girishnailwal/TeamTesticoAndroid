...
public class ActivityEditProfileBindingImpl extends ActivityEditProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ivEditCoach, 6);
        sViewsWithIds.put(R.id.ivCamera, 7);
        sViewsWithIds.put(R.id.edtName, 8);
        sViewsWithIds.put(R.id.edtPosition, 9);
        sViewsWithIds.put(R.id.edtEmail, 10);
        sViewsWithIds.put(R.id.tvChangePwd, 11);
        sViewsWithIds.put(R.id.btnUpdateProfile, 12);
    ...
    public ActivityEditProfileBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds));
    }
    private ActivityEditProfileBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
